...
function TContacts.APIExecute(BaseURL : string; Key : string; instancia : String): boolean;
var
...
begin
  ...
  try
    ...
    FRespContacts := TRespContacts.FromJsonString( '{"result": {"lista:" ' + LResponse.ContentAsString + '}}');
